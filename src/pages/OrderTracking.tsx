        ...
        <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-black/5">
          <div className="flex justify-between items-start mb-12">
            <div>
              ...
              <p className="text-black/60 font-medium">Order #LEX-AC-001</p>
            </div>
          ...
          <div className="bg-lex-soft rounded-3xl p-8 mb-12 flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-black/60 font-medium mb-4">Budi - LEX AC Technician</p>
              <div className="flex justify-center sm:justify-start gap-4">
                <button className="bg-lex-black text-white px-6 py-3 rounded-full font-bold text-sm">Chat</button>
                <button className="bg-black/5 text-lex-black px-6 py-3 rounded-full font-bold text-sm hover:bg-black/10">Call</button>
              </div>
            </div>
            <div className="text-center">
              <div className="text-sm text-black/40 font-bold uppercase mb-1">Arrival</div>
          ...
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-4 rounded-2xl bg-white border border-black/5 shadow-sm">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              <div className="flex items-center justify-center w-12 h-12 rounded-full border-4 border-white bg-lex-soft shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
              </div>
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-4 rounded-2xl bg-white border border-black/5 shadow-sm opacity-60">
                <div className="flex items-center justify-between space-x-2 mb-1">
