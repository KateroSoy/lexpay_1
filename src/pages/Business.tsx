import { PiArrowRight, PiShieldCheck, PiHardDrive, PiWifiHigh, PiWrench } from "react-icons/pi";
...
export default function Business() {
  return (
    <div className="bg-bg-main text-white min-h-screen">
      ...
      <section className="pt-40 pb-32 px-4 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="max-w-3xl mb-16">
            <span className="inline-block px-4 py-1.5 rounded-full bg-bg-card/10 text-white/80 font-bold text-sm tracking-widest uppercase mb-8">
              B2B Solutions
            </span>
            <h1 className="text-6xl md:text-8xl font-black tracking-tight mb-8 leading-[0.95]">
              LEX for<br />Business.
            </h1>
            <p className="text-xl md:text-2xl text-text-secondary font-medium max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-bg-card text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-bg-card/90 active:scale-95 transition-all">
              Lihat solusi bisnis
            </button>
            <button className="bg-bg-card/10 text-text-primary px-8 py-4 rounded-full font-bold text-lg hover:bg-bg-card/20 transition-all">
              Hubungi Sales
            </button>
          </div>
        </div>
      ...
      {/* Services Grid */}
      <section className="py-24 px-4 border-t border-border-main">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            
            <div className="bg-bg-card/5 rounded-[32px] p-8 hover:bg-bg-card/10 transition-colors group cursor-pointer border border-white/5 hover:border-white/20">
              <div className="w-14 h-14 bg-brand-network/20 text-brand-network rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <PiShieldCheck className="w-7 h-7 text-text-primary" />
              </div>
            ...
            <div className="bg-bg-card/5 rounded-[32px] p-8 hover:bg-bg-card/10 transition-colors group cursor-pointer border border-white/5 hover:border-white/20">
              <div className="w-14 h-14 bg-brand-network/20 text-brand-network rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <PiWifiHigh className="w-7 h-7 text-text-primary" />
              </div>
            ...
            <div className="bg-bg-card/5 rounded-[32px] p-8 hover:bg-bg-card/10 transition-colors group cursor-pointer border border-white/5 hover:border-white/20">
              <div className="w-14 h-14 bg-brand-comp/20 text-brand-comp rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <PiHardDrive className="w-7 h-7 text-text-primary" />
              </div>
            ...
            <div className="bg-bg-card/5 rounded-[32px] p-8 hover:bg-bg-card/10 transition-colors group cursor-pointer border border-white/5 hover:border-white/20">
              <div className="w-14 h-14 bg-brand-ac/20 text-brand-ac rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <PiWrench className="w-7 h-7 text-text-primary" />
              </div>
      ...
      <section className="py-32 px-4 text-center">
        ...
        <button className="bg-lex-purple text-white px-10 py-5 rounded-full font-bold text-xl hover:bg-lex-purple-start active:scale-95 transition-all inline-flex items-center gap-3">
          Mulai Konsultasi <PiArrowRight className="w-6 h-6" />
        </button>
      </section>
    </div>
  );
