  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="bg-[#FAF8F5] py-32 px-4 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2 max-w-lg">
            ...
            <button className="bg-[#78350F] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#3C1E0A] transition-colors shadow-xl">
              Order Coffee
            </button>
          </div>
        </div>
      ...
      <div className="bg-brand-pet py-32 px-4 relative overflow-hidden">
        <div className="absolute left-0 top-0 w-[600px] h-[600px] bg-white/40 rounded-full blur-[80px] -translate-x-1/3 -translate-y-1/3" />
        ...
        <div className="mx-auto max-w-7xl relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="max-w-lg">
            ...
            <button className="bg-lex-black text-white px-8 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform flex items-center gap-2">
              Shop Pet Essentials <ArrowRight className="w-5 h-5" />
            </button>
          </div>
