    ...
    <section className="relative min-h-[70vh] md:min-h-screen flex items-center justify-center pt-16 md:pt-24 pb-20 md:pb-0 px-4">
      ...
      <div className="relative z-10 mx-auto max-w-7xl flex flex-col items-center text-center w-full">
        ...
        <motion.form 
          ...
          className="mt-12 max-md:-mb-32 relative z-20 w-full max-w-3xl bg-bg-card p-3 md:p-2 rounded-2xl md:rounded-full shadow-2xl md:shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex max-md:flex-col md:flex-row items-center gap-3 border border-border-main focus-within:border-white/30 transition-all mx-4"
        >
          <div className="hidden md:flex pl-6">
            <PiMagnifyingGlass className="w-6 h-6 opacity-60 text-text-secondary" />
          </div>
          <div className="md:hidden w-full flex items-center px-4 py-2 bg-bg-main rounded-xl mb-2">
            <PiMagnifyingGlass className="w-5 h-5 opacity-60 text-text-secondary mr-3" />
            <input 
              type="text" 
              name="q"
              placeholder="Cari layanan atau produk..."
              className="flex-1 bg-transparent border-none outline-none text-base py-2 placeholder:opacity-60 text-text-secondary font-medium text-text-primary"
            />
          </div>
          <input 
            type="text" 
            ...
            className="hidden md:block flex-1 bg-transparent border-none outline-none text-lg py-4 placeholder:opacity-40 placeholder:text-text-secondary font-medium text-text-primary"
            onChange={(e) => {
