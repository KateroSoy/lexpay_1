...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[70vh] md:min-h-screen flex items-center justify-center pt-24 md:pt-28 pb-12 md:pb-0 px-4">
      ...
      <div className="relative z-10 mx-auto max-w-7xl flex flex-col items-center text-center w-full">
        ...
        >
          ...
          <span className="inline-block py-1.5 px-4 rounded-full bg-white/10 text-sm font-semibold mb-6 md:mb-8 text-white">
            All-in-One Commerce & Services
          </span>
          <h1 className="text-4xl sm:text-4xl md:text-6xl lg:text-7xl font-black leading-[0.95] tracking-[-0.04em] text-white mb-4 md:mb-6">
