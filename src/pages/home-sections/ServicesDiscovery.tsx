    ...
    <section className="py-32 px-4 bg-white">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1: AC */}
          <div className="bg-lex-soft rounded-[40px] p-10 flex flex-col justify-between min-h-[480px] group relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-md">
              ...
              <p className="text-lg text-black/60 font-medium mb-8">Servis, cleaning dan perawatan AC langsung dari teknisi profesional.</p>
              <div className="flex flex-wrap gap-2 mb-10">
                {['Cleaning', 'Maintenance', 'Repair', 'Installation'].map((chip) => (
                  <span key={chip} className="px-4 py-2 rounded-full bg-white text-sm font-semibold shadow-sm text-black/70">
                    {chip}
                  </span>
                ))}
              </div>
            </div>
            <button className="relative z-10 w-fit bg-lex-black text-white px-8 py-4 rounded-full font-bold group-hover:scale-105 transition-transform">
              Pesan Servis
            </button>
          </div>

          {/* Card 2: Network */}
          <div className="bg-lex-black rounded-[40px] p-10 flex flex-col justify-between min-h-[480px] group relative overflow-hidden text-white">
            ...
            <div className="relative z-10 max-w-md">
              <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 text-white font-bold text-sm mb-6">LEX Network</span>
              <h3 className="text-4xl font-black mb-4">Keep everything secure.</h3>
              <p className="text-lg text-white/60 font-medium mb-8">CCTV, networking, security systems and professional installation.</p>
            </div>
            <button className="relative z-10 w-fit bg-white text-lex-black px-8 py-4 rounded-full font-bold group-hover:scale-105 transition-transform">
              Lihat Solusi
            </button>
          </div>

          {/* Card 3: Comp */}
          <div className="bg-lex-black rounded-[40px] p-10 flex flex-col justify-between min-h-[480px] group relative overflow-hidden text-white md:col-span-2 lg:col-span-1">
            ...
            <div className="relative z-10 max-w-md">
              ...
              <p className="text-lg text-white/60 font-medium mb-8">Custom PC, upgrade, troubleshooting and technology consultation.</p>
            </div>
          ...
          <div className="bg-lex-soft rounded-[40px] p-10 flex flex-col justify-between min-h-[480px] group relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-md">
              ...
              <p className="text-lg text-black/60 font-medium mb-8">Booking barber tanpa antre lama. Premium modern barber environment.</p>
            </div>
