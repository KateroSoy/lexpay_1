...
export function Ecosystem() {
  return (
    <section className="py-32 bg-bg-main text-white px-4 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-bg-card/5 rounded-[32px] p-8 md:p-12 aspect-square md:aspect-auto md:min-h-[400px] flex flex-col justify-end relative overflow-hidden group">
          ...
          {/* Card 2 */}
          <div className="bg-brand-ac rounded-[32px] p-8 md:p-12 aspect-square flex flex-col justify-end relative overflow-hidden group text-text-primary">
            <div className="relative z-20">
          ...
          {/* Card 3 */}
          <div className="bg-brand-comp rounded-[32px] p-8 md:p-12 aspect-square flex flex-col justify-end relative overflow-hidden group text-text-primary">
            <div className="relative z-20">
          ...
          <div className="md:col-span-2 bg-brand-barber rounded-[32px] p-8 md:p-12 aspect-square md:aspect-[2/1] flex flex-col justify-end relative overflow-hidden group text-text-primary">
            <div className="relative z-20">
